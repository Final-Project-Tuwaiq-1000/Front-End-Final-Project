                ...
                <div class="navbar-inner">
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            {!state.userInfo.isLogged &&<li><Link to={"/LogIn"} ><input type="image"src={LogInIcon} className="imgNav"/></Link></li>}
                            ...
                            {state.userInfo.isLogged &&<li onClick={LogOut}><Link to={"/LogIn"}><input type="image" src={LogOut22} className="imgSizeNav"/></Link></li>}
                            {state.userInfo.userLogged.userRole==="ADMIN" &&<li><Link to={"/Admin"}><input type="image" src={AdminIcon} className="imgSizeNav"/></Link></li>}
                        </ul>
                    </div>
                </div>
            </div>
